...
--     is_uploaded_record BOOLEAN DEFAULT false,
...
-- CREATE INDEX idx_leads_uploaded_by ON leads(uploaded_by);
-- CREATE INDEX idx_leads_upload_batch_id ON leads(upload_batch_id);
-- CREATE INDEX idx_leads_is_uploaded_record ON leads(is_uploaded_record);
...
-- -- =====================================================
-- -- 9. LEAD UPLOADS TABLE (Bulk Upload Tracking)
-- -- =====================================================

-- CREATE TABLE lead_uploads (
--     id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
--     user_id UUID NOT NULL REFERENCES users(id) ON DELETE CASCADE,
--     upload_type VARCHAR(10) CHECK (upload_type IN ('lead', 'data')),
...
-- CREATE INDEX idx_lead_uploads_created_at ON lead_uploads(created_at);
